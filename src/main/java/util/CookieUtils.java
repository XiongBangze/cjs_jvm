...
public class CookieUtils {
	...
	public static void setCookie(HttpServletResponse response, String name, String value, int maxValue) {
		setCookie(response, name, value, maxValue, null);
	}
	
	public static void setCookie(HttpServletResponse response, String name, String value, int maxValue, String domain) {
		if (null == name) {
			return;
		}
		if (null == value) {
